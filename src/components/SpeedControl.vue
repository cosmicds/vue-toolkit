  ...
  <div id="speed-control">
    <div id="speed-buttons">
      <icon-button
        ...
        :aria-label="playbackRate < 0 ? 'Play time forward' : 'Play time backwards'"
        :color="color"
        :focus-color="color"
      ...
      <icon-button 
        ...
        :color="color"
        :focus-color="color"
        :aria-label="`Slow down ${rateDelta}x`"
      ...
      <icon-button 
        ...
        :color="color"
        :focus-color="color"
        :aria-label="`Speed up ${rateDelta}x`"
      ...
      >
        <template #activator>
          <icon-button
            ...
            :color="color"
            :focus-color="color"
            aria-label="More Speed Controls"
