  ...
  >
    <div class="dtp__row">
      <div class="dtp__grid-container">
        ...
        <!-- 2-6 -->
        <span class="dtp__middle-slot"><slot name="center" /></span>
        <!-- 3-6 -->
        <span />
